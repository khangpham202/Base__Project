...
if(isset($manv)){
	...
	$sql = "SELECT * from nhan_vien where manv = '$manv'";
											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														...
														<div class="staff-id">Employee ID : HOI-084</div>
												...
												<div class="col-md-7">
													<ul class="personal-info">
														...
														<li>
															...
															<div class="text">soumyadip.note@gmail.com</a></div>
														</li>
														<li>
						...
						<div id="emp_profile" class="pro-overview tab-pane fade show active">
							<div class="row">
									...
									<div class="card profile-box flex-fill">
										<div class="card-body">
											...
											<li>
												...
												<li>
													<div class="title">Birth Place:</div>
													<div class="text"> Demo</div>
												</li>
												<li>
													<div class="title">Birth State:</div>
													<div class="text"> Demo</div>
												</li>
												<li>
													<div class="title">Birth Country:</div>
													<div class="text"> Demo</div>
												</li>
													<li>
												...
												<hr>
													...
													<li>
													<div class="title">Blood Group RH:</div>
													<div class="text"> Demo</div>
												</li>
											</ul>
										</div>
								...
								<div class="col-md-6 d-flex">
									<div class="card profile-box flex-fill">
										<div class="card-body">
											<h3 class="card-title">Office Informations <a href="#" class="edit-icon" data-toggle="modal" data-target="#emergency_contact_modal"><i class="fa fa-pencil"></i></a></h3>
											...
											<hr>
												...
												<li>
													<div class="title">Working Number:</div>
													<div class="text">Demo</div>
												</li>
